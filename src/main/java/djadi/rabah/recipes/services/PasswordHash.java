...
public class PasswordHash
{
    ...
    public static boolean validatePassword(String password, String salt, String goodHash)
        throws NoSuchAlgorithmException, InvalidKeySpecException
    {
        return validatePassword(password.toCharArray(), salt, goodHash);
    }
     ...
     * @return              true if the password is correct, false if not
     */
    public static boolean validatePassword(char[] password, String goodSalt, String goodHash)
        throws NoSuchAlgorithmException, InvalidKeySpecException
    {
        int iterations = PBKDF2_ITERATIONS;
        byte[] salt = fromHex(goodSalt);
