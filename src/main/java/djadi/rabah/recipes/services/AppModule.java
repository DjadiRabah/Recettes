...
public class AppModule {
	...
	public static void contributeFactoryDefaults(MappedConfiguration<String, Object> configuration) {
		...
		// configuration.override(SymbolConstants.HOSTPORT_SECURE, "8080");
	}
	...
	public static void contributeApplicationDefaults(MappedConfiguration<String, Object> configuration) {
		...
		// client-side data.
		configuration.add(SymbolConstants.HMAC_PASSPHRASE, "MyHmacPassPhrase" + UUID.randomUUID());
	}

	// Pour changer la version de jquery
	// @Core
	// @Contribute(JavaScriptStack.class)
	// public static void overrideJquery(OrderedConfiguration<StackExtension> conf)
	// {
	// conf.override("jquery-library",
	// StackExtension.library("context:jquery/jquery-3.6.0.min.js"));
	// }
